...
public class ShowUserPropertyStmt extends ShowStmt {
    ...
    public List<List<String>> getRows(ConnectContext connectContext) {
        ...
        rows.add(Lists.newArrayList(UserProperty.PROP_DEFAULT_CATALOG, userProperty.getDefaultCatalog()));
        rows.add(Lists.newArrayList(UserProperty.PROP_DEFAULT_DATABASE, userProperty.getDefaultDatabase()));
