...
public class ShowUserPropertyStmt extends ShowStmt {
    ...
    public List<List<String>> getRows(ConnectContext connectContext) {
        ...
        rows.add(Lists.newArrayList(UserProperty.PROP_DEFAULT_SESSION_CATALOG, userProperty.getDefaultSessionCatalog()));
        rows.add(Lists.newArrayList(UserProperty.PROP_DEFAULT_SESSION_DATABASE, userProperty.getDefaultSessionDatabase()));
