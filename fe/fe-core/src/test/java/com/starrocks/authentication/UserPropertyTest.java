...
public class UserPropertyTest {
    ...
    public void testUpdate_WithMaxConn() throws Exception {
        ...
        try {
            ...
            List<Pair<String, String>> properties = new ArrayList<>();
            UserProperty userProperty = new UserProperty();
            properties.add(new Pair<>(UserProperty.PROP_MAX_USER_CONNECTIONS, "null"));
            userProperty.update("root", properties);
    ...
    public void testUpdate_WithCatalog() throws Exception {
        try {
            // set the catalog property for set root user
            ...
            properties.add(new Pair<>(UserProperty.PROP_DEFAULT_CATALOG, catalogName));
            UserProperty userProperty = new UserProperty();
            userProperty.update("root", properties);
            Assert.assertEquals(2000, userProperty.getMaxConn());
            Assert.assertEquals(catalogName, userProperty.getDefaultCatalog());

            // reset the catalog property for set root user
            properties = new ArrayList<>();
            properties.add(new Pair<>(UserProperty.PROP_MAX_USER_CONNECTIONS, "null"));
            properties.add(new Pair<>(UserProperty.PROP_DEFAULT_CATALOG, "null"));
            userProperty = new UserProperty();
            userProperty.update("root", properties);
            Assert.assertEquals(UserProperty.MAX_CONN_DEFAULT_VALUE, userProperty.getMaxConn());
            Assert.assertEquals(UserProperty.CATALOG_DEFAULT_VALUE, userProperty.getDefaultCatalog());
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public void testUpdate_WithUser() throws Exception {
        ...
        try {
            // test user can update properties
            userProperty.update("test", properties);
        } catch (Exception e) {
            Assert.assertEquals(1, 2);
        }
    ...
    public void testUpdate_WithDatabase() throws Exception {
        try {
            UserProperty userProperty = new UserProperty();
            List<Pair<String, String>> properties = new ArrayList<>();
            properties.add(new Pair<>(UserProperty.PROP_DEFAULT_DATABASE, "xxx"));
            userProperty.update("root", properties);
            Assert.assertEquals(1, 2);
        } catch (Exception e) {
        }
        ...
        try {
            ...
            UserProperty userProperty = new UserProperty();
            List<Pair<String, String>> properties = new ArrayList<>();
            properties.add(new Pair<>(UserProperty.PROP_DEFAULT_DATABASE, databaseName));
            userProperty.update("root", properties);
            Assert.assertEquals(databaseName, userProperty.getDefaultDatabase());

            // reset database for root user
            userProperty = new UserProperty();
            properties = new ArrayList<>();
            properties.add(new Pair<>(UserProperty.PROP_DEFAULT_DATABASE, "null"));
            userProperty.update("root", properties);
            Assert.assertEquals(UserProperty.DATABASE_DEFAULT_VALUE, userProperty.getDefaultDatabase());
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public void testUpdate_WithSessionVariables() throws Exception {
        ...
        try {
            ...
            properties = new ArrayList<>();
            properties.add(new Pair<>("session.wait_timeout", "null"));
            userProperty.update("root", properties);
            Assert.assertEquals(0, userProperty.getSessionVariables().size());
        } catch (Exception e) {
            Assert.assertEquals(1, 2);
    ...
    public void testUpdateForReplayJournal() {
        List<Pair<String, String>> properties = new ArrayList<>();
        properties.add(new Pair<>(UserProperty.PROP_MAX_USER_CONNECTIONS, "2000"));
        properties.add(new Pair<>(UserProperty.PROP_DEFAULT_DATABASE, "database"));
        properties.add(new Pair<>(UserProperty.PROP_DEFAULT_CATALOG, "catalog"));
        properties.add(new Pair<>("session.aaa", "bbb"));
        ...
        try {
            ...
            Assert.assertEquals(2000, userProperty.getMaxConn());
            Assert.assertEquals("database", userProperty.getDefaultDatabase());
            Assert.assertEquals("catalog", userProperty.getDefaultCatalog());
    ...
    public void testUpdateSessionContext_WithSomeAbnormalCases() {
        ...
        try {
            ...
            userProperty = new UserProperty();
            userProperty.setDefaultCatalog("catalog");
            userProperty.updateSessionContext(context);
        } catch (Exception e) {
            throw e;
        }
        ...
        try {
            ...
            userProperty = new UserProperty();
            userProperty.setDefaultDatabase("database");
            userProperty.updateSessionContext(context);
        } catch (Exception e) {
            throw e;
        }
    ...
    public void testGetCatalogDbName() {
        UserProperty userProperty = new UserProperty();
        userProperty.setDefaultDatabase("db");
        userProperty.setDefaultCatalog("catalog");
    ...
    public void testGetDefaultSessionDatabase() {
        UserProperty userProperty = new UserProperty();
        String defaultSessionDatabase = userProperty.getDefaultDatabase();
    ...
    public void testGetDefaultSessionCatalog() {
        UserProperty userProperty = new UserProperty();
        String defaultSessionCatalog = userProperty.getDefaultCatalog();
